  ...
  function console_log($output, $with_script_tags = true)
{
    ...
    if(isset($_SESSION['pointofsale'])){
        ...
        //create sequantial array for matchin`` array keys to products id's
        ...
        $_SESSION['pointofsale'][$count] = array
            ...
            for ($i = 0; $i < count($product_ids); $i++){
                if ($product_ids[$i] == filter_input(INPUT_GET, 'id')){
                    ...
                    // $query1111 = 'DELETE FROM product WHERE PRODUCT_ID= ' . $_SESSION['pointofsale'][$i]['id'];
                    // mysqli_query($db,$query1111)or die (mysqli_error($db));                  
