...
<?php endif; ?>    
          <?php if($isTouch = isset($total)): ?>
            <button type="submit" name="id" value=""class="btn btn-primary btn-block">SUBMIT</button>
          <?php endif; ?>   
          ...
          <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
              ...
              <div class="modal-footer">
                <button type="submit" name="id" value=""class="btn btn-primary btn-block">PROCEED TO PAYMENT</button>
